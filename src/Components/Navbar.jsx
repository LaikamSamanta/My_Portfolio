...
export default function Navbar() {
  ...
  <div className="ring w-12 rounded-full ring-offset-2 ring-neutral">
    <img src="src/assets/Samanta.jpg" />
  </div>
</div>
  </div>
...
<a className="download btn btn-outline btn-neutral">Download CV<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={2} stroke="currentColor" className="download-svg size-4">
